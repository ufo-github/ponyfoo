...
function setupOAuth1(name, Strategy, fields){
    ...
    var opts = {
        ...
        callbackURL: config.server2.authorityLanding + config.auth[name].callback,
...
function setupOpenId(name, Strategy){
    var opts = {
        returnURL: config.server2.authorityLanding + config.auth[name].callback,
        realm: config.server2.authorityLanding
    };
