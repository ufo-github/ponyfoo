...
Just a few days ago, [Google](http://google.com "Google Search Engine") started indexing [this blog](http://www.ponyfoo.com/ "Pony Foo"), and it's *just starting to show up* in their search results. I wanted to go over the steps I took to make a _good impression_ on them.
