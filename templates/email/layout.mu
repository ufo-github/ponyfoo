                                                ...
                                                <table border="0" cellpadding="0" cellspacing="0" width="100%" id="templateHeader">
                                                    <tr>
                                                        <td valign="top" class="headerContent">
                                                            <img src="cid:header" style="max-width:600px;" id="headerImage" alt="{{header.image.alt}}" />
                                                        </td>
                                                    </tr>
                                                </table>
                                                <!-- // END HEADER -->
                                                ...
                                                <table border="0" cellpadding="0" cellspacing="0" width="100%" id="templateFooter">
                                                    <tr>
                                                        <td valign="top" class="footerContent">
                                                            ...
                                                            {{/footer.twitter.url}}
                                                            {{#footer.landing.url}}
                                                                <a href="{{{footer.landing.url}}}">Visit {{footer.landing.title}}</a>
                                                            {{/footer.landing.url}} 
                                                        </td>
                                                    </tr>
                                                </table>
